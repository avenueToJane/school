...
},beforePageText:"当前页",afterPageText:"共 {pages}页",displayMsg:"第{from}到{to}条  总共{total}条数据",nav:{first:{iconCls:"pagination-first",handler:function(){
